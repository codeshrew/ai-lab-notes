...
export const videos = [
  {
    ...
    src: "/videos/ltx2-victorian-hallway.mp4",
    size: "758 KB",
    quality: "convincing",
    notes: "Minimal subject motion, strong atmospheric textures, slow deliberate camera movement. The flickering light gives the scene life without requiring complex object interaction.",
  },
  {
    title: "Spider Web Dew",
    genre: "Macro / Nature",
    ...
    src: "/videos/ltx2-spider-web-dew.mp4",
    size: "3.4 MB",
    quality: "convincing",
    notes: "Macro subjects with natural subtle motion are LTX-2's sweet spot. The trembling dewdrops and swaying web are physics-consistent motion the model handles well.",
  },
  {
    title: "Jazz Pianist",
    genre: "Music / Close-up",
    ...
    src: "/videos/ltx2-jazz-pianist.mp4",
    size: "2.2 MB",
    quality: "convincing",
    notes: "Hands-on-keys is a focused, repetitive motion the model reproduces well. Minor face warping only in the final frames as the camera pulls back.",
  },
  {
    ...
    src: "/videos/ltx2-cat-windowsill.mp4",
    size: "2.7 MB",
    quality: "solid",
  },
  {
    ...
    src: "/videos/ltx2-tokyo-alley.mp4",
    size: "3.7 MB",
    quality: "solid",
  },
  {
    title: "Northern Lights",
    genre: "Arctic / Landscape",
    ...
    src: "/videos/ltx2-northern-lights.mp4",
    size: "3.0 MB",
    quality: "solid",
  },
  {
    title: "Cowboy Sunset",
    genre: "Western / Silhouette",
    ...
    src: "/videos/ltx2-cowboy-sunset.mp4",
    size: "2.4 MB",
    quality: "solid",
  },
  {
    title: "Ink Drop",
    genre: "Abstract / Macro",
    ...
    src: "/videos/ltx2-ink-drop.mp4",
    size: "1.7 MB",
    quality: "solid",
  },
  {
    title: "Sea Turtle",
    genre: "Underwater / Nature",
    ...
    src: "/videos/ltx2-sea-turtle.mp4",
    size: "4.0 MB",
    quality: "solid",
  },
  {
    ...
    src: "/videos/ltx2-grizzly-bear.mp4",
    size: "5.0 MB",
    quality: "unconvincing",
    notes: "Object interaction breaks down \u2014 the bear and salmon move independently with no convincing physical connection. Water motion is good, but the \"catch\" never lands.",
  },
  {
    title: "Viking Fleet",
    genre: "Historical / Crowd",
    ...
    src: "/videos/ltx2-viking-fleet.mp4",
    size: "3.0 MB",
    quality: "unconvincing",
    notes: "Multiple similar objects clustered unrealistically close. Flat, unconvincing water surface. Looks like a pre-rendered video game cutscene rather than live footage.",
  },
  {
    title: "Astronaut",
    genre: "Sci-Fi / Zero Gravity",
    ...
    src: "/videos/ltx2-astronaut.mp4",
    size: "1.5 MB",
    quality: "unconvincing",
    notes: "Zero-gravity physics fail \u2014 the model produces a rigid, toy-like figure that hangs rather than floats. Background and Earth are decent but the astronaut breaks the illusion.",
  },
];

<img src="/ai-lab-notes/videos/hero-victorian-hallway.jpg" alt="AI-generated frame from a Victorian hallway video — flickering gas lamp illuminates a shadowy corridor with peeling wallpaper" style="width: 100%; border-radius: 12px; margin-bottom: 0.5rem;" />
<p style="text-align: center; font-size: 0.8rem; opacity: 0.5; margin-top: 0; margin-bottom: 2rem;">Still frame from an AI-generated video — LTX-2 19B Distilled on an RTX 3090</p>
